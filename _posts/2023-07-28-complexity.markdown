...
I actually struggled to agree with this notion that "complexity is bad" for many years. As you get more experienced and see more code you more honestly and humbly accept the presence of trade-offs in all of software engineering. Maybe even in all of life. So I was challenged many times to consider "[is there a good reason for complexity on occasion](https://www.youtube.com/watch?v=vagyIcmIGOQ&t=1197s)?". On reflection I still don't think there is a good reason to allow complexity, at least not until you've been working on a problem for a long time and you thoroughly understand it. 
